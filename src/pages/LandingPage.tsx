...
export const LandingPage: React.FC = () => {
  ...
  const demoLines = [
    ...
    '[ContriBot] 🔍 Running 2-model verification...',
    '  → gemini-3.1-pro-preview: ✅ Approved (9/10)',
    '  → gemini-3-flash-preview:  ✅ Approved (8/10)',
    '[ContriBot] 🎉 CONSENSUS: 2/2 — Safe to merge!',
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            ...
            <motion.p variants={fadeUp} className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              ContriBot writes code, reviews PRs with 2 AI models, manages releases, and handles your entire GitHub workflow — autonomously.
            </motion.p>
            ...
            <motion.div variants={fadeUp} className="mt-12 flex flex-wrap justify-center lg:justify-start gap-4">
              <Badge icon={<Cpu />} text="2 AI Models" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <StepCard 
              ...
              description="2 different AI models review the PR. If consensus is reached, you merge, and a release is auto-published."
              delay={0.5}
            />
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard 
              ...
              title="2-Model PR Verification"
              description="Consensus-based reviews using Gemini 3.1 Pro and 3 Flash to catch bugs and security flaws."
            />
            <FeatureCard 
      ...
      <section className="py-32 bg-[#0D1117] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Every PR generated by ContriBot is independently reviewed by 2 different AI models. Only when consensus is reached is it marked safe to merge.</p>
          </div>
          ...
          <motion.div 
            ...
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-12"
          >
          ...
          >
            <h3 className="text-2xl font-bold text-[#00FF88] flex items-center justify-center gap-3">
              <CheckCircle className="w-8 h-8" /> CONSENSUS: 2/2 — Safe to Merge
            </h3>
